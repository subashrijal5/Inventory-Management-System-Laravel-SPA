<template>
    <div class="flex flex-wrap">
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                :statSubtitle="$t('dashboard.orders')"
                ...
                :statDescripiron="$t('dashboard.since_last_month')"
        ...
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                :statSubtitle="$t('dashboard.profit')"
        ...
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                :statSubtitle="$t('dashboard.expenses')"
